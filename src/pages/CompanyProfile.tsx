            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="border-t border-border pt-4 mt-4">
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    <div><Label>Facturación Anual (€)</Label><Input type="number" value={company.facturacion_anual} onChange={e => setCompany(p => ({ ...p, facturacion_anual: e.target.value }))} /></div>
                    <div><Label>Patrimonio Neto (€)</Label><Input type="number" value={company.patrimonio_neto} onChange={e => setCompany(p => ({ ...p, patrimonio_neto: e.target.value }))} /></div>
                  </div>
                </div>
                ...
                {experience.map(exp => (
                  <div key={exp.id} className="border border-border rounded-lg p-4 space-y-3">
                    ...
                    <div className="grid sm:grid-cols-3 gap-3">
                      ...
                      <div><Label>Importe (€)</Label><Input type="number" value={exp.importe || ""} onChange={e => updateExperience(exp.id, "importe", e.target.value)} /></div>
